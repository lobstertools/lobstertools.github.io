    ...
    <section id="safety" className="my-16">
        <div className="bg-red-900/30 border border-red-700 text-red-200 px-6 py-5 rounded-lg shadow-lg">
            ...
            <p className="mt-3 text-red-100">
                This project is intended for educational and novelty purposes by responsible adults. Self-bondage carries inherent and
                serious risks, including nerve damage, circulation loss, and asphyxiation.
            </p>
            <ul className="list-disc list-outside space-y-2 mt-4 pl-5 text-red-200">
                <li>
                    You are building this toolkit at your <strong>own risk</strong>.
                </li>
                ...
                <li>
                    The creators of this project assume <strong>no liability</strong> for any harm, damage, or legal consequences.
                </li>
            </ul>
        </div>
    </section>
