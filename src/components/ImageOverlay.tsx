        ...
        <>
            ...
            >
                <div className="relative group">
                    ...
                    <img
                        ...
                        onError={(e) =>
                            (e.currentTarget.src = `https://placehold.co/600x400/2D3748/E2E8F0?text=${alt.replace(/\s/g, '+')}`)
                        }
                    />
            ...
            {isOpen && (
                ...
                >
                    ...
                    <button className="absolute top-4 right-4 z-50 text-white hover:text-gray-300" onClick={handleClose}>
                    ...
                    >
                        <img
                            ...
                            onError={(e) =>
                                (e.currentTarget.src = `https://placehold.co/1200x800/2D3748/E2E8F0?text=${alt.replace(/\s/g, '+')}`)
                            }
                        />
                        <p className="text-sm text-gray-400 mt-2 text-center">{alt}</p>
                    </div>
